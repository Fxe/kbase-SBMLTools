...
function SBMLTools(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    ...
    var _auth_cb = auth_cb;
     ...
     this.filter_contigs_changed = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "SBMLTools.filter_contigs_changed",
            [params], 1, _callback, _errorCallback);
    };
 
     this.do_nothing = function (_callback, _errorCallback) {
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        if (_errorCallback && typeof _errorCallback !== 'function')
            throw 'Argument _errorCallback must be a function if defined';
        ...
        return json_call_ajax(_url, "SBMLTools.do_nothing",
            [], 0, _callback, _errorCallback);
    };
 
     this.do_nothing_but_auth = function (_callback, _errorCallback) {
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        if (_errorCallback && typeof _errorCallback !== 'function')
            throw 'Argument _errorCallback must be a function if defined';
        if (typeof arguments === 'function' && arguments.length > 0+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(0+2)+')';
        return json_call_ajax(_url, "SBMLTools.do_nothing_but_auth",
            [], 0, _callback, _errorCallback);
    };
 
     this.read_sbml_model = function (params, _callback, _errorCallback) {
        if (typeof params === 'function')
            throw 'Argument params can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "SBMLTools.read_sbml_model",
            [params], 1, _callback, _errorCallback);
    };
