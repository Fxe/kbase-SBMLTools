...
public class GenomeProteomeComparisonClient {
    ...
    protected <T> JobState<T> _checkJob(String jobId, TypeReference<List<JobState<T>>> retType) throws IOException, JsonClientException {
        ...
        args.add(jobId);
        List<JobState<T>> res = caller.jsonrpcCall("GenomeProteomeComparison._check_job", args, retType, true, true);
        return res.get(0);
    }
     ...
     */
    protected String _blastProteomesSubmit(BlastProteomesParams input, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<String> res = caller.jsonrpcCall("GenomeProteomeComparison._blast_proteomes_submit", args, retType, true, true, jsonRpcContext);
        return res.get(0);
    }
    ...
    public String blastProteomes(BlastProteomesParams input, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        String jobId = _blastProteomesSubmit(input, jsonRpcContext);
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<String> res1 = caller.jsonrpcCall("GenomeProteomeComparison._status_submit", args, retType1, true, true, jsonRpcContext);
