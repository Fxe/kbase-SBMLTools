...
public class ModelReaction {
    ...
    private List<sbmltools.ModelReactionProtein> modelReactionProteins;
    @JsonProperty("gapfill_data")
    private Map<String, Map<Long, Tuple3 <String, Long, List<sbmltools.ModelReactionProtein>>>> gapfillData;
    ...
    @JsonProperty("modelReactionProteins")
    public List<sbmltools.ModelReactionProtein> getModelReactionProteins() {
        return modelReactionProteins;
    }

    @JsonProperty("modelReactionProteins")
    public void setModelReactionProteins(List<sbmltools.ModelReactionProtein> modelReactionProteins) {
        this.modelReactionProteins = modelReactionProteins;
    }

    public ModelReaction withModelReactionProteins(List<sbmltools.ModelReactionProtein> modelReactionProteins) {
        this.modelReactionProteins = modelReactionProteins;
        return this;
    }

    @JsonProperty("gapfill_data")
    public Map<String, Map<Long, Tuple3 <String, Long, List<sbmltools.ModelReactionProtein>>>> getGapfillData() {
        return gapfillData;
    }

    @JsonProperty("gapfill_data")
    public void setGapfillData(Map<String, Map<Long, Tuple3 <String, Long, List<sbmltools.ModelReactionProtein>>>> gapfillData) {
        this.gapfillData = gapfillData;
    }

    public ModelReaction withGapfillData(Map<String, Map<Long, Tuple3 <String, Long, List<sbmltools.ModelReactionProtein>>>> gapfillData) {
        this.gapfillData = gapfillData;
        return this;
    }
