...
public class SBMLToolsServer extends JsonServerServlet {
    ...
    private static final String gitUrl = "git@github.com:Fxe/kbase-SBMLTools.git";
    private static final String gitCommitHash = "30312590ff608e4d974b401ac4c319f75230f1f3";
