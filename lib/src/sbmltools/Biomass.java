...
public class Biomass {
    ...
    private List<sbmltools.BiomassCompound> biomasscompounds;
    @JsonProperty("removedcompounds")
    private List<sbmltools.BiomassCompound> removedcompounds;
    ...
    @JsonProperty("biomasscompounds")
    public List<sbmltools.BiomassCompound> getBiomasscompounds() {
        return biomasscompounds;
    }

    @JsonProperty("biomasscompounds")
    public void setBiomasscompounds(List<sbmltools.BiomassCompound> biomasscompounds) {
        this.biomasscompounds = biomasscompounds;
    }

    public Biomass withBiomasscompounds(List<sbmltools.BiomassCompound> biomasscompounds) {
        this.biomasscompounds = biomasscompounds;
        return this;
    }

    @JsonProperty("removedcompounds")
    public List<sbmltools.BiomassCompound> getRemovedcompounds() {
        return removedcompounds;
    }

    @JsonProperty("removedcompounds")
    public void setRemovedcompounds(List<sbmltools.BiomassCompound> removedcompounds) {
        this.removedcompounds = removedcompounds;
    }

    public Biomass withRemovedcompounds(List<sbmltools.BiomassCompound> removedcompounds) {
        this.removedcompounds = removedcompounds;
        return this;
    }
