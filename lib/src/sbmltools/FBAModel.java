...
public class FBAModel {
    ...
    private List<sbmltools.ModelReaction> modelreactions;
    @JsonProperty("gapfilledcandidates")
    private List<sbmltools.ModelReaction> gapfilledcandidates;
    ...
    @JsonProperty("modelreactions")
    public List<sbmltools.ModelReaction> getModelreactions() {
        return modelreactions;
    }

    @JsonProperty("modelreactions")
    public void setModelreactions(List<sbmltools.ModelReaction> modelreactions) {
        this.modelreactions = modelreactions;
    }

    public FBAModel withModelreactions(List<sbmltools.ModelReaction> modelreactions) {
        this.modelreactions = modelreactions;
        return this;
    }

    @JsonProperty("gapfilledcandidates")
    public List<sbmltools.ModelReaction> getGapfilledcandidates() {
        return gapfilledcandidates;
    }

    @JsonProperty("gapfilledcandidates")
    public void setGapfilledcandidates(List<sbmltools.ModelReaction> gapfilledcandidates) {
        this.gapfilledcandidates = gapfilledcandidates;
    }

    public FBAModel withGapfilledcandidates(List<sbmltools.ModelReaction> gapfilledcandidates) {
        this.gapfilledcandidates = gapfilledcandidates;
        return this;
    }
