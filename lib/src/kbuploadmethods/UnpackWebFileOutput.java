...
/**
 * <p>Original spec-file type: UnpackWebFileOutput</p>
 * <pre>
...
public class UnpackWebFileOutput {
    ...
    public UnpackWebFileOutput withUnpackedFilePath(String unpackedFilePath) {
        this.unpackedFilePath = unpackedFilePath;
        return this;
    }
    ...
    public String toString() {
        return ((((("UnpackWebFileOutput"+" [unpackedFilePath=")+ unpackedFilePath)+", additionalProperties=")+ additionalProperties)+"]");
    }
